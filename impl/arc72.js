...
import ARC200Spec from "../abi/arc/72/contract.json" assert { type: "json" }; // spec
import ARC200Extension from "../abi/arc/72/extension.json" assert { type: "json" }; // extension (non-standard methods)
import { oneAddress } from "../constants/accounts.js";
import { prepareString } from "../utils/encoding.js";
